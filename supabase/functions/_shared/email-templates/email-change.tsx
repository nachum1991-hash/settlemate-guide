...
export const EmailChangeEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your new email address for SettleMate</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            You asked to change the email on your SettleMate account from{' '}
          ...
          <Hr style={hr} />
          <Text style={footer}>
            If you didn't request this, please reset your password and contact
            us right away to secure your account.
          </Text>
        </Section>
