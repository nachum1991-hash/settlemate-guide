...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email to get started with SettleMate</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          <Heading style={h1}>Welcome to SettleMate 👋</Heading>
          <Text style={text}>
            We're so glad you're here. SettleMate helps international students
            like you settle into Italy — visa, paperwork, arrival, and finding
            your people.
          </Text>
          <Text style={text}>
            Just one quick step: please confirm <strong>{recipient}</strong> so
          ...
          <Hr style={hr} />
          <Text style={footer}>
            If you didn't sign up for SettleMate, you can safely ignore this
