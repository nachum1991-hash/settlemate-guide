...
const Index = () => {
  ...
  const handlePhaseClick = (phaseId: number) => {
    switch (phaseId) {
      case 1: navigate('/home-country'); break;
      case 2: navigate('/arrival-italy'); break;
      case 3: navigate('/social-integration'); break;
    }
  };

  const phases = [
    { id: 1, title: "From Home Country", icon: Plane, description: "Prepare your visa and documents before departure", color: "primary", status: "active" },
    { id: 2, title: "Arrival in Italy", icon: MapPin, description: "Complete essential bureaucracy within 1-4 weeks", color: "secondary", status: "active" },
    { id: 3, title: "Social Integration", icon: Users, description: "Build your community and settle into Italian life", color: "accent", status: "active" },
  ];
